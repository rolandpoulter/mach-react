  ...
  _createClass(BaseComponent, [{
    ...
    value: function update(force) {
      ...
      var afterRender = function afterRender() {
        ...
        if (_this2.domNode) delete _this2.domNode.component;
        _this2.domNode = _this2.resolveDOM(_this2);
      ...
      if (this.renderAsync) {
        this.renderAsync(this.constructor, function (newVirtualElement) {
          _this2.virtualElement = newVirtualElement;
          afterRender();
        });
      } else {
